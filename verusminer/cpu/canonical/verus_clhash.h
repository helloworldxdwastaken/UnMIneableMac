...
// ARM build — use SSE2NEON shim, no cpuid/x86intrin
...
inline bool IsCPUVerusOptimized()
{
    ...
    // Apple Silicon (M1/M2/M3/M4/M5) always has AES + PMULL via ARMv8 crypto
...
struct verusclhasher {
    ...
    {
// __tls_init() is libcxx-internal — clang on macOS handles thread_local init
// automatically without it, so we just skip the call.
